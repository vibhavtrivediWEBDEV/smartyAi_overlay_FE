  ...
  useGSAP(() => {
    ...
    if (heroTitle) {
      ...
      hero
        ...
        .from("[data-hero-promo]", { y: 20, scale: 0.93, autoAlpha: 0, duration: 0.95, ease: "elastic.out(1, 0.48)" }, "-=0.2")
        .from("[data-hero-proof] > *", { y: 48, scale: 0.88, autoAlpha: 0, stagger: 0.12, duration: 1.1, ease: "elastic.out(1, 0.5)" }, "-=0.5")
        .from("[data-hero-disclosure]", { y: 14, scale: 0.96, autoAlpha: 0, duration: 0.88, ease: "elastic.out(1, 0.42)" }, "-=0.75")
